    ...
    <div className="flex min-h-screen bg-gradient-to-br from-pink-50 via-pink-100 to-rose-100">
      <div className="relative flex flex-col items-center justify-center w-full max-w-5xl p-6 mx-auto my-8 bg-white rounded-2xl shadow-lg md:flex-row">
        ...
        <div className="w-full p-6 md:w-1/2 md:p-8">
          <h2 className="mb-8 text-3xl font-bold text-center text-gray-900">Login</h2>
          
          <form onSubmit={handleSubmit} className="w-full space-y-6">
            <div>
              <label htmlFor="usernameOrEmail" className="block mb-2 text-sm font-medium text-gray-700">
                Username or Email
              </label>
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-sm font-medium text-red-400 hover:text-red-500 transition-colors">
                Forgot Password?
              </Link>
            </div>
